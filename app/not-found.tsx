...
export default function NotFoundUser() {
    return (
        <div className="bg-slate-200 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2" >
            ...
            <center className="mt-6">
                <Link href="/" className="text-gray-500 font-mono text-xl bg-slate-300 p-3 rounded-md hover:shadow-md">Go home </Link>
            </center>
        </div>
    )
}