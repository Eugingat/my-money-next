export default function Welcome({name}: {name?: string}) {
    ...
    if (name) {
        return (
            <div className='uppercase text-center text-7xl font-mono flex flex-col gap-6 mt-6' >
    ...
    return (
        <div className='uppercase text-center text-7xl font-mono flex flex-col gap-6' >
